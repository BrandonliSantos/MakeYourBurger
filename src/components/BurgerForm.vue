<template>
    <div>
        ...
        <div>
            <form id="burger-form" @submit="criarBruger($event)">
                ...
                <div class="input-container">
                    ...
                    <select name="pao" id="pao" v-model="pao">
                        <option :value="null" selected disabled hidden>Selecione o seu pão</option>
                ...
                <div class="input-container">
                    ...
                    <select name="carne" id="carne" v-model="carne">
                        <option :value="null" selected disabled hidden>Selecione o tipo de carne</option>
